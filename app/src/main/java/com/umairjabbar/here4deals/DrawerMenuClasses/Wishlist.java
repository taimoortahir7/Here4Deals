...
public class Wishlist extends AppCompatActivity {
    ...
    private String postUrl = "https://www.here4deals.com/wishlist";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToggle = new ActionBarDrawerToggle(Wishlist.this, mDrawerLayout, R.string.open, R.string.close);
        ...
        App home = new App(Wishlist.this, mNavigationView);
        home.setNavigationItemSelectedListener();

        if(!NetworkUtils.isConnected(Wishlist.this)){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.view_as_list_or_block:
                Intent intent2 = new Intent(Wishlist.this, GalleryActivity.class);
