...
public class Messages extends AppCompatActivity {
    ...
    private String postUrl = "https://www.here4deals.com/members/messaging/browse/filter/received";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        App home = new App(Messages.this, mNavigationView);
        home.setNavigationItemSelectedListener();

        if(!NetworkUtils.isConnected(Messages.this)){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.view_as_list_or_block:
                Intent intent2 = new Intent(Messages.this, GalleryActivity.class);
