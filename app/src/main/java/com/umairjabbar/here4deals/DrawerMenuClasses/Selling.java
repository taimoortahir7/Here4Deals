...
public class Selling extends AppCompatActivity {
    ...
    private String postUrl = "https://www.here4deals.com/members/selling/browse/open";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToggle = new ActionBarDrawerToggle(Selling.this, mDrawerLayout, R.string.open, R.string.close);
        ...
        App home = new App(Selling.this, mNavigationView);
        home.setNavigationItemSelectedListener();

        if(!NetworkUtils.isConnected(Selling.this)){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.view_as_list_or_block:
                Intent intent2 = new Intent(Selling.this, GalleryActivity.class);
                startActivity(intent2);
                break;
            case R.id.cart:
                Intent intent = new Intent(Selling.this, Cart.class);
