...
public class Buy extends AppCompatActivity {
    ...
    private String postUrl = "https://www.here4deals.com/members/buying/purchases";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToggle = new ActionBarDrawerToggle(Buy.this, mDrawerLayout, R.string.open, R.string.close);
        ...
        App home = new App(Buy.this, mNavigationView);
        home.setNavigationItemSelectedListener();

        if(!NetworkUtils.isConnected(Buy.this)){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.view_as_list_or_block:
                Intent intent2 = new Intent(Buy.this, GalleryActivity.class);
