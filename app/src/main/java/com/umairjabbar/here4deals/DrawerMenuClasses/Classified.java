...
public class Classified extends AppCompatActivity {
    ...
    private String postUrl = "https://www.here4deals.com/sell";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToggle = new ActionBarDrawerToggle(Classified.this, mDrawerLayout, R.string.open, R.string.close);
        ...
        App home = new App(Classified.this, mNavigationView);
        home.setNavigationItemSelectedListener();

        if(!NetworkUtils.isConnected(Classified.this)){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.view_as_list_or_block:
                Intent intent2 = new Intent(Classified.this, GalleryActivity.class);
                startActivity(intent2);
                break;
            case R.id.cart:
                Intent intent = new Intent(Classified.this, Cart.class);
