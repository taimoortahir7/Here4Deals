...
public class SignupView extends AppCompatActivity {
    ...
    private String postUrl = "https://www.here4deals.com/register";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToggle = new ActionBarDrawerToggle(SignupView.this, mDrawerLayout, R.string.open, R.string.close);
        ...
        App home = new App(SignupView.this, mNavigationView);
        home.setNavigationItemSelectedListener();

        if(!NetworkUtils.isConnected(SignupView.this)){
