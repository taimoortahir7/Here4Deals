...
public class Terms extends AppCompatActivity {
    ...
    private String postUrl = "https://www.here4deals.com/terms";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToggle = new ActionBarDrawerToggle(Terms.this, mDrawerLayout, R.string.open, R.string.close);
        ...
        App home = new App(Terms.this, mNavigationView);
        home.setNavigationItemSelectedListener();

        if (!NetworkUtils.isConnected(Terms.this)){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.view_as_list_or_block:
                Intent intent2 = new Intent(Terms.this, GalleryActivity.class);
                startActivity(intent2);
                break;
            case R.id.cart:
                Intent intent = new Intent(Terms.this, Cart.class);
