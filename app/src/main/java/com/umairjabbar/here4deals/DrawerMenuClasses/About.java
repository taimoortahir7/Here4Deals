...
public class About extends AppCompatActivity {
    ...
    private String postUrl = "https://www.here4deals.com/about-us";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToggle = new ActionBarDrawerToggle(About.this, mDrawerLayout, R.string.open, R.string.close);
        ...
        App home = new App(About.this, mNavigationView);
        home.setNavigationItemSelectedListener();

        if(!NetworkUtils.isConnected(About.this)){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.view_as_list_or_block:
                Intent intent1 = new Intent(About.this, GalleryActivity.class);
                startActivity(intent1);
                break;
            case R.id.cart:
                Intent intent = new Intent(About.this, Cart.class);
