...
public class LogoutView extends AppCompatActivity {
    ...
    private String postUrl = "https://www.here4deals.com/logout";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToggle = new ActionBarDrawerToggle(LogoutView.this, mDrawerLayout, R.string.open, R.string.close);
        ...
        App home = new App(LogoutView.this, mNavigationView);
        home.setNavigationItemSelectedListener();

        if (!NetworkUtils.isConnected(LogoutView.this)){
