...
public class Stores extends AppCompatActivity {
    ...
    private String postUrl = "https://www.here4deals.com/all-stores";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToggle = new ActionBarDrawerToggle(Stores.this, mDrawerLayout, R.string.open, R.string.close);
        ...
        App home = new App(Stores.this, mNavigationView);
        home.setNavigationItemSelectedListener();

    if (!NetworkUtils.isConnected(Stores.this)){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.view_as_list_or_block:
                Intent intent2 = new Intent(Stores.this, GalleryActivity.class);
                startActivity(intent2);
                break;
            case R.id.cart:
                Intent intent = new Intent(Stores.this, Cart.class);
