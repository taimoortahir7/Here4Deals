...
public class Following extends AppCompatActivity {
    ...
    private String postUrl = "https://www.here4deals.com/members/tools/favorite-stores";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToggle = new ActionBarDrawerToggle(Following.this, mDrawerLayout, R.string.open, R.string.close);
        ...
        App home = new App(Following.this, mNavigationView);
        home.setNavigationItemSelectedListener();

        if (!NetworkUtils.isConnected(Following.this)){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.view_as_list_or_block:
                Intent intent2 = new Intent(Following.this, GalleryActivity.class);
                startActivity(intent2);
                break;
            case R.id.cart:
                Intent intent = new Intent(Following.this, Cart.class);
