...
public class Help extends AppCompatActivity {
    ...
    private String postUrl = "https://www.here4deals.com/faq";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToggle = new ActionBarDrawerToggle(Help.this, mDrawerLayout, R.string.open, R.string.close);
        ...
        App home = new App(Help.this, mNavigationView);
        home.setNavigationItemSelectedListener();

        if(!NetworkUtils.isConnected(Help.this)){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.view_as_list_or_block:
                Intent intent2 = new Intent(Help.this, GalleryActivity.class);
                startActivity(intent2);
                break;
            case R.id.cart:
                Intent intent = new Intent(Help.this, Cart.class);
