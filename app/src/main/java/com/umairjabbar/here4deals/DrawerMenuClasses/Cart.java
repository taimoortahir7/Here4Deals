...
public class Cart extends AppCompatActivity {
    ...
    private String postUrl = "https://www.here4deals.com/cart";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToggle = new ActionBarDrawerToggle(Cart.this, mDrawerLayout, R.string.open, R.string.close);
        ...
        App home = new App(Cart.this, mNavigationView);
        home.setNavigationItemSelectedListener();

        if(!NetworkUtils.isConnected(Cart.this)){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.view_as_list_or_block:
                Intent intent2 = new Intent(Cart.this, GalleryActivity.class);
